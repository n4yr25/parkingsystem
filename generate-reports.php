	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
				<div class="col-lg-12">
					...
					<center><button type="button" class="btn btn-info" onclick="exportTableToCSV('example.csv')"><i class="fa fa-print fa-1x" aria-hidden="true" ></i>Export to CSV</button></center>
				</div>
