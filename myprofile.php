<?php
    ...
    include('includes/dbconn.php');
        ...
        if (strlen($_SESSION['vpmsaid']==0)) {
            ...
            $query=mysqli_query($con, "UPDATE admin set FullName ='$fullname', MobileNumber='$mobnum' where ID='$adminid'");
            if ($query) {
						...
						$msg</div>" ?> 
							...
							<form method="POST">
                                ...
                                <div class="col-lg-6">
									...
									<input type="text" class="form-control" value="<?php  echo $row['FullName'];?>" id="adminname" name="name" required>
								</div>
                                </div>
